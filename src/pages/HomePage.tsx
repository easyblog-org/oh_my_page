...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="container mx-auto px-6 md:px-12 py-4 md:py-4 flex flex-col items-center text-center relative">
        ...
        <div className="max-w-2xl relative z-10 mb-10">
          ...
          <div className={`flex flex-col sm:flex-row gap-5 justify-center w-full transition-all duration-500 ease-out ${showButtons ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            <Button size="lg" variant="outline" className="w-full sm:w-auto px-10 py-6 text-lg font-medium group" onClick={() => {
      ...
      {/* Featured Projects */}
      <section id="projects" className="bg-muted/30 py-12 md:py-20">
      ...
      {/* Call to Action */}
      <section id="contact" className="container mx-auto px-6 md:px-12 py-16 md:py-28 text-center">
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">联系我</h2>
        <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-16 leading-relaxed">
          准备好提升您的内容营销策略了吗？让我们一起讨论如何为您的品牌创造有影响力的内容。
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {/* 邮箱联系 */}
          <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300 hover:cursor-pointer transition-cursor duration-300">
