            ...
            {navItems.map((item) =>
              item.href ? (
                <a
                  ...
                  className="relative text-base text-[#e2e8f0] hover:text-[#3b82f6] transition-colors duration-200"
                >
                  {item.name}
                </a>
              ) : (
            ...
            {navItems.map((item) =>
              item.href ? (
                <a
                  ...
                  target={item.external ? "_blank" : undefined}
                  rel={item.external ? "noopener noreferrer" : undefined}
                  className="text-lg text-left text-[#e2e8f0] hover:text-[#3b82f6] transition-colors duration-200"
                >
                  {item.name}
                </a>
              ) : (
